...
function Modal({ onCloseClick, children, actionBar }) {
    ...
    useEffect(() => {
        ...
        return () => {
            document.body.classList.remove("overflow-hidden")}  // enables back when its's hidden
    }, []);
    ...
    return reactDOM.createPortal( // this method tells react to render the modal in a different place
        ...
        <div>   
            ...
            <div onClick={onCloseClick} className="fixed inset-0 bg-gray-300 opacity-80"></div>
